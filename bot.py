...
async def create_welcome_image(member: discord.Member) -> BytesIO | None:
    ...
    try:
        ...
        # أبعاد وموقع الدائرة في قالب الترحيب.
        # نخلي الصورة أكبر قليلًا من مكان الصورة القديمة (overscan)
        # حتى تغطي الحواف بالكامل ولا يظهر أي جزء من الصورة الأصلية.
        ...
        # قناع دائري كامل مع تغطية إضافية للحواف
        mask = Image.new("L", (diameter, diameter), 0)
        ImageDraw.Draw(mask).ellipse((0, 0, diameter - 1, diameter - 1), fill=255)

        # وضع صورة العضو فوق مكان الصورة القديمة مع زيادة بسيطة للحجم
        # حتى لا تبقى أي حافة من صورة الحصان ظاهرة.
